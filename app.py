...
model = joblib.load('D:\\johanbernardd\\uni\\COURSE\\Rakamin Academy\\random_forest_model.pkl')
encoders = joblib.load('D:\\johanbernardd\\uni\\COURSE\\Rakamin Academy\\label_encoders.pkl')
